// https://github.com/aws/aws-xray-sdk-node/blob/481d8456c480cabc371137f78d0b47b623507b2f/packages/core/types/index.d.ts
...
declare module "aws-xray-sdk-core" {
  ...
  export type AWSClient = InstanceType<
    typeof AWSClients[keyof typeof AWSClients]
  >;
  ...
  export type ContextMissingStrategy =
    | "LOG_ERROR"
    | "RUNTIME_ERROR"
    | ((message: string) => void);
  ...
  export function setContextMissingStrategy(
    strategy: ContextMissingStrategy
  ): void;
  ...
  export namespace utils {
    function getCauseTypeFromHttpStatus(
